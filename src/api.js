...
const upcoming_games = `games?key=824e421e1add4ebf9b4ddfdc631267a9&dates=${currentDate},${nextYear}&ordering=-added&page_size=20`;
const newGames =  `games?key=824e421e1add4ebf9b4ddfdc631267a9&dates=${lastYear},${currentDate}&ordering=-released&page_size=20`;
